      ...
      <span>
        ...
        <span className="af-view">
          <div className="af-class-body-2">
            <div id="form-wrapper" data-w-id="84fca19c-1a71-328d-f997-a8fc85dcbd7c" style={{opacity: 0, display: 'inline-block'}} className="af-class-form_wrapper">
              <div data-w-id="c7d1aa52-bdbc-0d92-f7b3-a6c597f875aa" className="af-class-form-close" />
              <div className="af-class-form1-0">
                <div data-w-id="cd7877a9-903b-7c6a-d384-392f6320caef" className="af-class-close"><img src="images/close_icon_black.png" loading="lazy" sizes="24px" srcSet="images/close_icon_black-p-500.png 500w, images/close_icon_black.png 600w" alt /></div>
                <div className="af-class-div-block-8">
                  ...
                  <div className="af-class-form-block w-form">
                    <form id="wf-form-make-2" name="wf-form-make-2" data-name="make" redirect="https://h2hukjth21.execute-api.us-east-1.amazonaws.com/api/tasks'" data-redirect="https://h2hukjth21.execute-api.us-east-1.amazonaws.com/api/tasks'" method="post" className="af-class-form">
                      <div className="w-row">
                        <div className="af-class-column-8 w-col w-col-6">
                          <div className="w-layout-grid af-class-grid-5">
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb3182-cac2a066" className="af-class-section-5 af-class-wf-section"><input type="text" className="af-class-text-field-3 w-input" autofocus="true" maxLength={256} name="Make" data-name="Make" placeholder id="Make" required /></div>
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb318c-cac2a066" className="af-class-section-7 af-class-wf-section"><input type="text" className="af-class-text-field-3 w-input" maxLength={256} name="TitleStatus" data-name="TitleStatus" placeholder id="TitleStatus" required /></div>
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb3191-cac2a066" className="af-class-section-8 af-class-wf-section"><input type="text" className="af-class-text-field-3 w-input" maxLength={256} name="FirstName" data-name="FirstName" placeholder id="FirstName" required /></div>
                        ...
                        <div className="af-class-column-9 w-col w-col-6">
                          <div className="w-layout-grid af-class-grid-4">
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb319d-cac2a066" className="af-class-section-5 af-class-wf-section"><input type="text" className="af-class-text-field-2 w-input" maxLength={256} name="Model" data-name="Model" placeholder id="Model" required /></div>
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb31a2-cac2a066" className="af-class-section-6 af-class-wf-section"><input type="text" className="af-class-text-field-2 w-input" maxLength={256} name="Mileage" data-name="Mileage" placeholder id="Mileage" required /></div>
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb31a7-cac2a066" className="af-class-section-7 af-class-wf-section"><input type="text" className="af-class-text-field-2 w-input" maxLength={256} name="Transmission" data-name="Transmission" placeholder id="Transmission" required /></div>
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb31ac-cac2a066" className="af-class-section-8 af-class-wf-section"><input type="text" className="af-class-text-field-2 w-input" maxLength={256} name="LastName" data-name="LastName" placeholder id="LastName" required /></div>
                            ...
                            <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb31b1-cac2a066" className="af-class-section-9 af-class-wf-section"><input type="text" className="af-class-text-field-2 w-input" maxLength={256} name="PostalCode" data-name="PostalCode" placeholder id="PostalCode" required /></div>
                          </div>
                        </div>
                      </div>
                      <div className="af-class-container-8 w-container">
                        <div className="w-layout-grid af-class-grid-7">
                          ...
                          <div id="w-node-_9a6d4092-2f7a-c26a-e7ca-1b864ecb31b8-cac2a066" className="af-class-section-12 af-class-wf-section"><input type="email" className="af-class-text-field-2 w-input" maxLength={256} name="Email" data-name="Email" placeholder id="Email" required /></div>
                        </div>
                      </div>
            ...
            <div className="af-class-nav">
              <div data-animation="default" data-collapse="medium" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navbar w-nav">
                <div className="af-class-container-9 w-container"><img src="images/Autodopt_Logo_Red.png" loading="lazy" height={40} sizes="(max-width: 479px) 43.625px, 65.453125px" srcSet="images/Autodopt_Logo_Red-p-500.png 500w, images/Autodopt_Logo_Red-p-800.png 800w, images/Autodopt_Logo_Red-p-1080.png 1080w, images/Autodopt_Logo_Red.png 1500w" alt className="af-class-image-29" /></div>
            ...
            <div className="af-class-div-block">
              <div className="af-class-columns-2 w-row">
                <div className="af-class-column-5 w-col w-col-4"><img src="images/Autodopt_Icon_1.png" loading="lazy" sizes="(max-width: 479px) 60.078125px, 120.15625px" srcSet="images/Autodopt_Icon_1-p-500.png 500w, images/Autodopt_Icon_1.png 726w" alt className="af-class-image-26" />
                  <h1 className="af-class-heading-10">Step 1</h1>
                  <div className="af-class-text-block-7">Fill out our form</div>
                </div>
                <div className="af-class-column-6 w-col w-col-4"><img src="images/Autodopt_Icon_2.png" loading="lazy" sizes="(max-width: 479px) 55.453125px, 110.90625px" srcSet="images/Autodopt_Icon_2-p-500.png 500w, images/Autodopt_Icon_2.png 855w" alt className="af-class-image-25" />
                  <h1 className="af-class-heading-10">Step 2</h1>
                  <div className="af-class-text-block-7">Hear from our buyer</div>
                </div>
                <div className="af-class-column-7 w-col w-col-4"><img src="images/Autodopt_Icon_3.png" loading="lazy" sizes="(max-width: 479px) 93.203125px, 186.421875px" srcSet="images/Autodopt_Icon_3-p-500.png 500w, images/Autodopt_Icon_3-p-800.png 800w, images/Autodopt_Icon_3.png 1260w" alt className="af-class-image-27" />
              ...
              <div className="af-class-div_block_content">
                ...
                <div className="af-class-section-17 af-class-wf-section">
                  <div data-delay={4000} data-animation="slide" className="af-class-slider w-slider" data-autoplay="false" data-easing="ease" data-hide-arrows="false" data-disable-swipe="false" data-autoplay-limit={0} data-nav-spacing={3} data-duration={500} data-infinite="true">
                    <div className="af-class-mask w-slider-mask">
                      ...
                      <div className="w-slide">
                        <div className="af-class-container-12 w-container"><img width={271} sizes="(max-width: 479px) 65vw, 100vw" src="images/photo_2022-01-16_18-53-422.jpg" loading="lazy" srcSet="images/photo_2022-01-16_18-53-422-p-500.jpeg 500w, images/photo_2022-01-16_18-53-422-p-800.jpeg 800w, images/photo_2022-01-16_18-53-422.jpg 917w" alt className="af-class-team_portrait" />
                ...
                <div className="af-class-section-2 af-class-wf-section">
                  <div className="af-class-columns w-row">
                    ...
                    <div className="af-class-column-2 w-col w-col-4"><img src="images/nick-temp.png" loading="lazy" width={150} alt className="af-class-image-21" />
                      <h1 className="af-class-heading-5">Nick Geisler</h1>
                      <div className="af-class-text-block-6">Partner, Sales and Marketing</div>
                    </div>
                    <div className="w-col w-col-4"><img src="images/photo_2022-01-16_18-53-422.jpg" loading="lazy" width={150} sizes="(max-width: 479px) 100vw, 150px" srcSet="images/photo_2022-01-16_18-53-422-p-500.jpeg 500w, images/photo_2022-01-16_18-53-422-p-800.jpeg 800w, images/photo_2022-01-16_18-53-422.jpg 917w" alt />
