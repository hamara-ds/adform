          ...
          <div>
            <div data-animation="default" data-collapse="medium" data-duration={400} data-easing="ease" data-easing2="ease" role="banner" className="af-class-navbar w-nav">
              <div className="af-class-container-2 w-container">
                <a href="#" className="af-class-brand w-nav-brand"><img src="images/logo.png" loading="lazy" width={55} sizes="(max-width: 479px) 14px, (max-width: 767px) 7vw, 55px" srcSet="images/logo-p-500.png 500w, images/logo.png 836w" alt className="af-class-image-18" />
